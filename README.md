## robot_localization (jazzy) - 3.8.2-1

The packages in the `robot_localization` repository were released into the `jazzy` distro by running `/root/venv/bin/bloom-release -r jazzy robot_localization --override-release-repository-push-url git@github.com:revyos-ros/robot_localization-release.git` on `Mon, 23 Jun 2025 05:53:51 -0000`
...
- release repository: https://github.com/revyos-ros/robot_localization-release.git
...
## robot_localization (jazzy) - 3.8.1-1

The packages in the `robot_localization` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r jazzy robot_localization --override-release-repository-push-url git@github.com:revyos-ros/robot_localization-release.git` on `Sun, 29 Sep 2024 04:52:06 -0000`
...
## robot_localization (humble) - 3.5.3-2

The packages in the `robot_localization` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble robot_localization` on `Mon, 06 May 2024 04:00:03 -0000`
...
## robot_localization (jazzy) - 3.8.0-1

The packages in the `robot_localization` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -t jazzy -r jazzy robot_localization --edit` on `Wed, 24 Apr 2024 09:47:07 -0000`
...
## robot_localization (rolling) - 3.9.0-1

The packages in the `robot_localization` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -t rolling -r rolling robot_localization` on `Wed, 24 Apr 2024 09:40:02 -0000`
...
The packages in the `robot_localization` repository were released into the `lunar` distro by running `/usr/bin/bloom-release -r lunar robot_localization` on `Thu, 25 Oct 2018 16:14:15 -0000`
